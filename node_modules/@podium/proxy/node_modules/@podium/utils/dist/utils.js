...
const deserializeContext = (headers = {}, prefix = 'podium') => {
    ...
    Object.keys(headers).forEach(key => {
        if (key.startsWith(prefix)) {
            const k = camelcase__default['default'](key.replace(`${prefix}-`, ''));
...
exports.duplicateOnLocalsPodium = duplicateOnLocalsPodium;
exports.getFromLocalsPodium = getFromLocalsPodium;
exports.isFunction = isFunction;
exports.isString = isString;
exports.pathnameBuilder = pathnameBuilder;
exports.serializeContext = serializeContext;
exports.setAtLocalsPodium = setAtLocalsPodium;
exports.uriBuilder = uriBuilder;
exports.uriIsRelative = uriIsRelative;
exports.uriRelativeToAbsolute = uriRelativeToAbsolute;
