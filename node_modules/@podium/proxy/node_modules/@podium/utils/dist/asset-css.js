...
class PodiumAssetCss {
    ...
    get value() {
        ...
        return utils.uriIsRelative(value) ? utils.pathnameBuilder(pathname, value) : value;
    }
    ...
    toHTML() {
        return htmlUtils.buildLinkElement(this);
    }
    ...
    toJsxAttributes() {
        return htmlUtils.buildReactLinkAttributes(this);
    }
